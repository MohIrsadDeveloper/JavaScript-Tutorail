// sort method 
// ASCII TABLE  (refer document of ASCII TABLE)
//char : ascii value
...
//  5,8,1200,400,3000
// 5,8,400,1200,3000 (expected)

const numbers = [5, 8, 1200, 400, 3000];
numbers.sort();
console.log(numbers);
// (5) [1200, 3000, 400, 5, 8]
// above code does not give expected result

// sort by accessding order
numbers.sort((a, b) => {
    return a - b;
});
console.log(numbers);

// sort by dessending order
numbers.sort((a, b) => {
    return b - a;
})
console.log(numbers);